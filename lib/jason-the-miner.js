...
/**
 * Jason the Miner aka as the Web scraper.
 * See the "demo" folder for usage examples.
 * @see ../demo/index.js
 */
class JasonTheMiner {
  /**
   * Creates an instance of the class and registers the default processors and parse helpers.
   * Additional processors and helpers can be passed as parameters.
   * @param  {Object} [options={}]
   * @param  {Object} [options.processors] An additional set of processors to register, as defined
   * in "processors/index.js"
   * @param  {Object} [options.helpers] An additional set of parse helpers to register, as defined
   * in "parse/helper.index.js"
   */
  ...
  /**
   * Reggisters a new processor, i.e. a class that must implement the "run()" and the
   * "getRunContext()" methods.
   * @param  {Object} options
   ...
   * If pagination is defined, 1) and 2) are repeated according to the pagination config.
   * @param  {Object} [options={}]
   ...
   * category. See "index.js" in each processor subfolders ("processors/input/index.js", etc.).
