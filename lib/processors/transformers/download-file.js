...
class FileDownloader {
   ...
   * URL for downloading
   * @param {string} [config.folder='.'] The ouput folder
  ...
  _download(url, currentCount, totalCount) {
    ...
    return this._httpClient.get(url)
      ...
      .then(response => {
        ...
        const filename = this._buildFilename(url, contentType, currentCount, totalCount);
   ...
   * @return {string}
   */
  _buildFilename(fileUrl, contentType, currentCount, totalCount) {
